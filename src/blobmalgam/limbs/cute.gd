...
static func leg() -> Limb:
	return Limb.new({
		...
		Ability.IMAGE : preload("res://assets/cute_leg.png"),
...
static func arm() -> Limb:
	return Limb.new({
		...
		Ability.DESC : "Dunno how to sound cute about this without being disingenious.",
		Ability.IMAGE : preload("res://assets/cute_arm.png"),
...
static func wings() -> Limb:
	return Limb.new({
		...
		Ability.DESC : "Dunno how to sound cute about these without being disingenious.",
		Ability.IMAGE : preload("res://assets/cute_wing.png"),
...
static func cat_ears() -> Limb:
	return Limb.new({
		...
		Ability.DESC : "Dunno how to sound cute about these without being disingenious.",
		Ability.IMAGE : preload("res://assets/cute_ears.png"),
